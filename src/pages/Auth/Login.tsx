      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-6">
          <div className="flex items-center justify-center">
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 p-4 rounded-3xl shadow-lg">
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className={`pl-12 h-12 text-base border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-600 focus:ring-blue-600 ${
                      errors.email ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''
                    }`}
                  />
                </div>
                {errors.email && (
                  <Alert variant="destructive" className="py-2 bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800">
              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className={`pl-12 pr-12 h-12 text-base border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-600 focus:ring-blue-600 ${
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 h-8 w-8 p-0 hover:bg-gray-100 dark:hover:bg-gray-600"
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <Button
                  type="button"
                  variant="link"
                  className="p-0 h-auto text-sm font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300"
                >
                  Forgot password?
                </Button>
              </div>
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 text-base font-semibold bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading && (
                  <div className="inline-block mr-3 h-5 w-5 animate-spin rounded-full border-2 border-white border-t-transparent" />
                )}
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button
                type="button"
                variant="outline"
                className="h-12 font-medium border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
              >
